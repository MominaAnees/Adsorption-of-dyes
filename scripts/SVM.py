...
print("Mean Squared Error for Adsorption efficiency(%):", mse[2])
r2 = r2_score(y_test, y_pred, multioutput='raw_values')
print("R2 Score for Adsorption efficiency(%):", r2[2])

#%%
df = pd.read_excel('predicted_data_with_inputs_SVRpoly_BG.xlsx')
df_subset = df.head(200)
df.head(200)
df_subset = df.head(200)
sns.set_theme(style='darkgrid')
...
#%%
df = pd.read_excel('predicted_data_with_inputs_SVRrbf_BG.xlsx')
df_subset = df.head(200)
df.head(200)
df_subset = df.head(200)
sns.set_theme(style='darkgrid')
